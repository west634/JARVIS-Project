...
export default async function ParentThreadPage({ params }: PageProps<"/parent/messages/[threadId]">) {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <Link href="/parent/messages" className="text-sm font-medium text-indigo-600 hover:underline dark:text-indigo-400">
          ← Messages
        </Link>
